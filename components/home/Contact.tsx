  ...
  return (
    <div className="w-full ">
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="bg-[#E30613] text-white py-16 px-4 md:px-8 lg:px-16 xl:px-40 flex flex-col items-center md:items-end justify-center text-center md:text-left">
        ...
        <div className="bg-white py-16 px-4 md:px-8 lg:px-16 xl:px-40 flex flex-col items-center md:items-start">
          <div className="max-w-md">
